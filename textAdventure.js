...
function text1(){
    console.log("Je slaat het raampje gauw in en verwijdert zorgvuldig het glas. Je onbewust van de in roze geklede mannen achter je wurm je je bovenlijf door het ontstane gat, tot je rond je middel toch echt klem komt te zitten. Beseffend dat je niet verder vooruit zult komen probeer je je terug te trekken, maar ook dit wilt niet meer gaan.\nOp dat moment grijpen de roze mannen in en trekken ze je hardvochtig terug uit het gat in het raam. Met een schreeuw van pijn en een fikse snee in je zij beland je op de grond, waar je nog net ziet hoe de arm van een van de mannen met een zwarte knuppel hard op je slaap neerkomt.\nWanneer je weer wakker wordt zie je even niets en raak je in paniek bij de gedachte dat je blind bent, tot je beseft dat er überhaupt niets te zien valt en dat het gewoon te donker is om ook maar iets over je omgeving te kunnen waarnemen. Op de vraag van in welk wespennest je nu in hemelsnaam bent beland heb je evenmin een antwoord, wat de situatie alleen maar frustrerender maakt.\nBij het geluid van knarsende scharnieren word je opeens klaarwakker, en even later komt een van de tegels naast je omhoog. Althans, dat neem je maar aan. Wie er ook verantwoordelijk is voor de verschuivende tegel, hij of zij heeft geen zichtbare lichtbron bij zich, waardoor het in het vertrek nog steeds gitzwart is. Op hetzelfde moment vliegt er een deur open - zo klinkt het tenminste - en klinken er gehaaste stemmen in de gang. Je...")
    console.log("")
    console.log("A. ...wacht wat er ook door de deur komt niet langer af en duikt op de plek af waar vermoedelijk een gat in de vloer zit.\nB. ...besluit de mensen die op je afkomen rustig uit te horen. Ze hebben vast niets dan goeds in de zin.")
    answer = question()
    if (answer == 'a') {
        text4()
    }
...
function text2(){
    ...
    console.log("")
    console.log("A. ...roept om hulp.\nB. ...probeert de deur open te breken.\nC. ...wurmt jezelf door het veel te kleine raampje in een poging buiten te geraken.")
    answer = ''
    while (answer != 'a' && answer != 'b' && answer != 'c') {
        answer = readlineSync.question('Wat doe je? (A / B / C): ').toLowerCase()
    }
    if (answer == 'a') {
        console.clear()
        text18()
...
function text3(){
    ...
    console.log("")
    console.log("A. ...besluit de volgende Uri die verschijnt zelf neer te slaan en er dan maar het beste van te maken.\nB. ...wacht nog even af.")
    answer = question()
    if (answer == 'a') {
        text11()
    }
...
function text4(){
    ...
    console.log("")
    console.log("A. Je stemt in met het plan, nog steeds zonder goed te weten wat het eigenlijk inhoudt.\nB. Je begint een beetje moe te worden van alle geheimzinnigheid en eist opheldering voordat je ook nog maar één poot verzet.")
    answer = question()
    if (answer == 'a') {
        text10()
    }
...
function text8(){
    console.log("Een van de Uri's begint je erop te wijzen dat het je paard is dat poten verzet en dat jij daar niets over te zeggen heeft, maar wanneer je hem met een goed gemikte kaakstoot van zijn eigen paard af laat duikelen besluit de rest om maar te luisteren. De overgebleven Uri's leggen je uit dat jij de koning moet vergezellen op zijn dagelijkse jachttocht in het naburige bos om hem voor loerende sluipmoordenaars te beschermen.Of je nu goede of kwade bedoelingen voor de koning hebt, met het plan instemmen is in alle gevallen de voor de hand liggende keuze. Zonder goed te weten waarom ga je dus akkoord en ga je verder bij.")
...
function text9(){
    console.log("Met een machtige worp slinger je de dwergmarmot in je hand met een noodvaart in de algemene richting van het mogelijke gevaar. Wanneer het pluizige beestje met een zachte boog in het groen landt komt het in een gigantische explosie van licht en geluid tot leven. Je duikt van je paard af in een wanhopige poging aan het helse tafereel te ontkomen en maakt daarbij kennis met een strategisch opgesteld en totaal niet onopvallend rotsblok. Een oog dichtknijpend en je bloedende neus negerend draai je je gauw om naar de smeulende resten van de pluizenbol die je net nog in je handen had en naar een onherkenbare, zwartgeblakerde vlek die vermoedelijk tot voor even kort aan een sluipschutter toebehoorde.Er is echter één ding dat je aandacht direct trekt. Midden in de gloeiende krater staat de kruisboog namelijk nog steeds fier en ongeschonden overeind. Je kijkt om naar de koning, die bewusteloos onder zijn paard ligt, en naar de twee andere leden van het gezelschap, die tijdens de verwarring blijkbaar tegen elkaar zijn opgereden en even bewusteloos een eind verderop liggen. Je bedenkt je dat, als je nu de koning doodschiet en de schuld legt bij de Uri's (de kwaadwillende, uiteraard), niemand aan je woord zal twijfelen en dat je dit dus risicoloos kan doen. Je staat nu voor de eeuwige tweesplitsing die je zo vaak tegenkomt: de keuze tussen goed en kwaad. Je...")
    console.log("")
    console.log("A. ....laat de koning leven in naam van het goede.\nB. ...schiet de hulpeloze man dood in naam van het kwaad.")
    answer = question()
    if (answer == 'a') {
        text20()
    }
...
function text10(){
    ...
    console.log("")
    console.log("A. ...neemt geen risico's en werpt direct een dwergmarmot naar de struik.\nB. ...besluit dat het je aandacht niet waard is - of dat je het helemaal niet erg vindt als de koning sterft - en kijkt opvallend nonchalant strak de andere kant op.")
    answer = question()
    if (answer == 'a') {
        text9()
    }
...
function text13(){
    console.log("De kandelaar floept op magische wijze weer aan en plots is de kamer weer prettig verlicht. Je trekt snel een leren wambuis over je nachthemd heen en doet een stevige broek aan. Vervolgens grijp je de kandelaar en loop je met stevige passen richting de voordeur. Onderweg raap je nog je zwaard op en klem je dit stevig in je rechterhand vast.Eenmaal bij de voordeur zet je de kandelaar neer en open je voorzichtig de deur op een kier, half verwachtend dat er over enkele ogenblikken een horde goblins naar binnen stormt. Er staat echter maar één goblin, helemaal verzopen en eerder lachwekkend dan angstaanjagend. Snel drukt hij een vochtige brief in je handen, waardoor je je zwaard laat vallen, om vervolgens door een gat in de heg de nacht in te verdwijnen. Je...")
    console.log("")
    console.log("A. ...rent de goblin achterna.\nB. ...leest de brief.")
    answer = question()
    if (answer == 'a') {
        text5()
    }
...
function text14(){
    ...
    console.log("")
    console.log("A. ...doet de deur open.\nB. ...gaat in de kelder schuilen.")
    answer = question()
    if (answer == 'a') {
        text13()
    }
...
function text19(){
    console.log(`Je besluit verder geen aandacht aan de goblin te besteden, sluit de deur weer en opent voorzichtig de brief, er goed op lettend dat het vochtige papier niet scheurt. Op het velletje papier staan slechts enkele woorden: "Kom zo snel mogelijk. Ik wacht bij de eenzame eik." Onderaan staan drie vergulde letters die het woord "Uri" spellen.Je herinnert je dat er in het Takkenbos, niet al te ver van je huis, een grote, buur loze eik staat. Deze zal vast bedoeld worden in het briefje. Maar wie of wat is Uri? En wat moet hij van jou? Je besluit om...`)
    console.log("")
    console.log(`A. ...deze "Uri" te ontmoeten.\nB. ...het briefje te negeren.`)
    answer = question()
    if (answer == 'a') {
        text12()
    }
...
function einde1(){
    console.log("Einde 1: Doodlopend einde")
}

function einde2(){
    console.log("Einde 2: Normaal einde")
}

function einde3(){
    console.log("Einde 3: Kwaad einde")
}

function einde4(){
    console.log("Einde 4: Goed einde")
}